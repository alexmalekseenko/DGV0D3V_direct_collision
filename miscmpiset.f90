...
!  Alex 06/21/2012
!
!  Miscellaneous setup for MPI execution of the UWVFbgk code. 
!  constains setting variables to fork the processes and such . 
!!!!!!!!!!!!!!!!!!!!!!1
...
use commvar, only: numchnks,num_Acopies,nodes_u,A_capphi,procs_nodes_wld, &
...
use commvar, only: procs_nodes_wld,nodes_phican,A_capphi
...
use commvar, only: procs_nodes_wld,nodes_phican,A_capphi,num_Acopies
