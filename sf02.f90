...
use commvar, only: R => gasR,gasTref,gamma=>gasalpha,gasmuref! these parameters are set in parameters.dat
...
! R = gasR ! the ordinary gas constant 
! gamma = gasalpha !    ! interior degree of freedom? 
! mass = mol_mass! molecular mass
real (DP), parameter, private :: mass=6.63d-26 
! conditions before the shock wave,
real (DP), parameter, private :: T1=0.2_DP  ! dimensionless temperature  -- ratio to T_{\infyt}, 
real (DP), parameter, private :: d1=2.00014_DP  ! dimensionless density == ration to initial number density
real (DP), parameter, private :: u1=1.2247472_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
real (DP), parameter, private :: v1=0.0_DP ! v1=?
real (DP), parameter, private :: w1=0.0_DP ! w1=?

! condtions after the shock wave 
real (DP), parameter, private :: T2=0.7333333_DP   !  dimensionless temperature  -- ratio to T_{\infyt}, 
real (DP), parameter, private :: d2=5.9984_DP   !  dimensionless density == ration to initial number density
real (DP), parameter, private :: u2=0.4082448_DP ! dimensionless bulk velocity  -- ratio to C_{\infty}
real (DP), parameter, private :: v2=0.0_DP ! v2=?
real (DP), parameter, private :: w2=0.0_DP ! w2=?
! 
real (DP), parameter, private :: lambda = 1_DP ! charachteristic length
!
